...
window.addEventListener("hashchange", () => {
  ...
  if (index != -1) {
    console.log("beginning " + currentURL.substring(0, index));
    console.log("end " + currentURL.substring(index));
  }
  changePage();
});
...
function setUpCss() {
  let cover = document.getElementById("imgcover");
  let header = document.getElementById("header");
  let nav = document.getElementById("nav");
  let navClosed = document.getElementById("nav-closed");
  let navOpen = document.getElementById("nav-open");
  let rickmorty = document.getElementById("rickmorty");
  let h3 = document.getElementById("nav-closed-h3");
  ...
  navClosed.style.width = "100%";
  navClosed.style.display = "block";
  navClosed.style.height = "auto";
...
function addSearchResults(json, searchType) {
  let footer = docuemnt.getElementById("footer");
}
